      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@enfpdev/napi-rs-enigo-android-arm64')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'arm':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@enfpdev/napi-rs-enigo-android-arm-eabi')
          }
        } catch (e) {
          loadError = e
        }
  ...
  case 'darwin':
    ...
    try {
      if (localFileExisted) {
        ...
        nativeBinding = require('@enfpdev/napi-rs-enigo-darwin-universal')
      }
      break
    } catch {}
    switch (arch) {
      case 'x64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@enfpdev/napi-rs-enigo-darwin-x64')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@enfpdev/napi-rs-enigo-darwin-arm64')
          }
        } catch (e) {
          loadError = e
        }
  ...
  case 'freebsd':
    ...
    try {
      if (localFileExisted) {
        ...
        nativeBinding = require('@enfpdev/napi-rs-enigo-freebsd-x64')
      }
    } catch (e) {
      loadError = e
    }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('@enfpdev/napi-rs-enigo-linux-x64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('@enfpdev/napi-rs-enigo-linux-x64-gnu')
            }
          } catch (e) {
            loadError = e
          }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('@enfpdev/napi-rs-enigo-linux-arm64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('@enfpdev/napi-rs-enigo-linux-arm64-gnu')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 'arm':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('@enfpdev/napi-rs-enigo-linux-arm-gnueabihf')
          }
        } catch (e) {
          loadError = e
        }
